...
hi  Cursor          guifg=bg        guibg=#88AACC   gui=NONE
...
hi  IncSearch       guifg=#ffffff   guibg=#0033ff   gui=bold
hi  LineNr          guifg=#353535   guibg=#070707   gui=NONE
hi  MatchParen      guifg=#0099FF   guibg=NONE        gui=bold 		"parenthasis match
hi  ModeMsg         guifg=#000000   guibg=#0088AF   gui=bold
...
hi  PmenuSel        guifg=#009acd   guibg=#1f1f1f   gui=bold
...
hi  Search          guifg=#000000   guibg=#6f8fff   gui=bold
...
hi  StatusLine      guifg=#ddeeff   guibg=#030303   gui=NONE 		"window titles
